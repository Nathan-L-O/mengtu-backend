 ...
 */
@CrossOrigin
@Controller(value = "linkshowProjectController")
@ResponseBody
@RequestMapping(value = "/linkshow", produces = {"application/json;charset=UTF-8"})
public class ProjectController {
    ...
    public Result<ProjectVO> createProject(ProjectRestRequest request, HttpServletRequest httpServletRequest) {
        return RestOperateTemplate.operate(LOGGER, "创建 linkshow 项目", request, new RestOperateCallBack<ProjectVO>() {
            @Override
            public void before() {
            ...
            public Result<ProjectVO> execute() {
                ...
                return RestResultUtil.buildSuccessResult(
                        LinkshowProjectVOConverter.convert(projectService.create(builder.build())), "创建项目成功");
            }
        });
    }
    ...
    public Result<ProjectVO> updateProject(ProjectRestRequest request, HttpServletRequest httpServletRequest) {
        return RestOperateTemplate.operate(LOGGER, "更新 linkshow 项目信息", request, new RestOperateCallBack<ProjectVO>() {
            @Override
            public void before() {
                AssertUtil.assertNotNull(request, RestResultCode.ILLEGAL_PARAMETERS, "请求体不能为空");
            ...
            public Result<ProjectVO> execute() {
                ...
                return RestResultUtil.buildSuccessResult(
                        LinkshowProjectVOConverter.convert(projectService.update(builder.build())), "更新项目信息成功");
            }
        });
    }
    ...
    public Result<ProjectVO> getProjectInstance(ProjectRestRequest request, HttpServletRequest httpServletRequest) {
        return RestOperateTemplate.operate(LOGGER, "查询 linkshow 项目实体", request, new RestOperateCallBack<ProjectVO>() {
            @Override
            public void before() {
                AssertUtil.assertNotNull(request, RestResultCode.ILLEGAL_PARAMETERS, "请求体不能为空");
                AssertUtil.assertStringNotBlank(request.getProjectId(), RestResultCode.ILLEGAL_PARAMETERS, "项目 ID 不能为空");
            ...
            public Result<ProjectVO> execute() {
                ...
                return RestResultUtil.buildSuccessResult(
                        LinkshowProjectVOConverter.convert(projectService.query(builder.build())), "获取项目实体信息成功");
            }
        });
    }
    ...
    public Result<List<ProjectVO>> getProject(ProjectRestRequest request, HttpServletRequest httpServletRequest,
        ...
        return RestOperateTemplate.operate(LOGGER, "查询 linkshow 项目", request, new RestOperateCallBack<List<ProjectVO>>() {
            @Override
            public void before() {
                AssertUtil.assertNotNull(request, RestResultCode.ILLEGAL_PARAMETERS, "请求体不能为空");
                AssertUtil.assertStringNotBlank(request.getDomainId(), RestResultCode.ILLEGAL_PARAMETERS, "域 ID 不能为空");
            ...
            public Result<List<ProjectVO>> execute() {
                ...
                return RestResultUtil.buildSuccessResult(CollectionUtil.toStream(
                        ...
                        .map(LinkshowProjectVOConverter::convert)
    ...
    public Result<String> changeArchiveStatus(ProjectRestRequest request, HttpServletRequest httpServletRequest) {
        return RestOperateTemplate.operate(LOGGER, "变更 linkshow 项目归档状态", request, new RestOperateCallBack<String>() {
            @Override
            public void before() {
                AssertUtil.assertNotNull(request, RestResultCode.ILLEGAL_PARAMETERS, "请求体不能为空");
                AssertUtil.assertStringNotBlank(request.getProjectId(), RestResultCode.ILLEGAL_PARAMETERS, "项目 ID 不能为空");
    ...
    public Result<ProjectVO> duplicateProject(ProjectRestRequest request, HttpServletRequest httpServletRequest) {
        return RestOperateTemplate.operate(LOGGER, "复制 linkshow 项目", request, new RestOperateCallBack<ProjectVO>() {
            @Override
            public void before() {
                AssertUtil.assertNotNull(request, RestResultCode.ILLEGAL_PARAMETERS, "请求体不能为空");
                AssertUtil.assertStringNotBlank(request.getProjectId(), RestResultCode.ILLEGAL_PARAMETERS, "项目 ID 不能为空");
            ...
            public Result<ProjectVO> execute() {
                ...
                return RestResultUtil.buildSuccessResult(
                        LinkshowProjectVOConverter.convert(projectVersionService.duplicateVersion(builder.build())), "复制项目成功");
            }
        });
    }
